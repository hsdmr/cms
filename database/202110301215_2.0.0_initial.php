...
class Initial200
{
    public function up()
    {
        ...
        $sql['user'] = "CREATE TABLE `phprest`.`user` ( `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT , `first_name` VARCHAR(255) NULL , `last_name` VARCHAR(255) NULL , `role` VARCHAR(50) NOT NULL , `email` VARCHAR(255) NOT NULL , `email_verified_at` BIGINT(20) NULL , `password` VARCHAR(255) NOT NULL , {$timestamps_with_delete} , PRIMARY KEY (`id`), UNIQUE `uniqeu_email` (`email`)) ENGINE = InnoDB;";
        $sql['user_meta'] = "CREATE TABLE `phprest`.`user_meta` ( `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT , `user_id` BIGINT(20) NOT NULL , `key` VARCHAR(255) NOT NULL , `value` TEXT NOT NULL , {$timestamps} , PRIMARY KEY (`id`)) ENGINE = InnoDB;";
