...
class Initial200
{
  public function up()
  {
    ...
    $sql['user'] = "CREATE TABLE `phprest`.`user` ( `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT , `first_name` VARCHAR(255) NULL , `last_name` VARCHAR(255) NULL , `role` VARCHAR(50) NOT NULL , `email` VARCHAR(255) NOT NULL , `username` VARCHAR(255) NOT NULL , `nickname` VARCHAR(255) NULL , `phone` VARCHAR(255) NULL , `email_verified_at` BIGINT(20) NULL , `password` VARCHAR(255) NOT NULL , {$timestamps_with_delete} , PRIMARY KEY (`id`), UNIQUE `uniqeu_email` (`email`)) ENGINE = InnoDB;";
    $sql['option'] = "CREATE TABLE `phprest`.`option` ( `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT ,`type` VARCHAR(255) NULL , `type_id` BIGINT(20) NULL , `key` VARCHAR(255) NOT NULL , `value` TEXT NULL , {$timestamps} , PRIMARY KEY (`id`)) ENGINE = InnoDB;";
