...
class Initial200
{
  public function up()
  {
    ...
    $sql['post'] = "CREATE TABLE `post` ( `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT , `slug_id` BIGINT(20) NOT NULL , `user_id` BIGINT(20) NOT NULL , `file_id` BIGINT(20) NULL , `status` VARCHAR(50) NOT NULL , `title` VARCHAR(255) NOT NULL , `content` LONGTEXT NULL , `sidebar` VARCHAR(255) NULL , `template` VARCHAR(255) NULL , {$timestamps_with_delete} , PRIMARY KEY (`id`)) ENGINE = InnoDB;";
